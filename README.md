...
- `index.html` — entry point, embeds the site below
- `ui_kits/portfolio/` — the site itself (sections, photography gallery, resume)
- `assets/` — images and the hologram background video
